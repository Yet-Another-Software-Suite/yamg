...
export default function MechanismForm({ form }: { form: UseFormReturn<any> }) {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardContent className="pt-6 bg-zinc-800 rounded-lg">
      ...
      >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between">
                    ...
                    <FormControl>
                      <Switch
                        className={field.value ? "bg-zinc-600" : "bg-gray-600"}
                        checked={field.value}
        ...
        <AccordionItem value="controlConfig">
          <AccordionTrigger className="p-4 items-center">
            <SlidersVertical /> Control Configuration
          </AccordionTrigger>
          <AccordionContent>
            <div className="space-y-4">
              <div className="space-y-2">
