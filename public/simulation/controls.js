// Ensure ControlsBaseSim is properly exposed to the global scope
// WPILib Controls Simulation Library
// Based on https://github.com/wpilibsuite/frc-docs/tree/main/source/_extensions/controls_js_sim
...
class ControlsBaseSim {
  ...
  update(dt) {
    ...
    // Add feedforward
    const ffOutput = this.calculateFeedforward(
      this.velocity,
      this.acceleration,
    );
...
console.log("ControlsBaseSim loaded and assigned to window");
